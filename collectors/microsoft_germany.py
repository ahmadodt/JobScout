...
MICROSOFT_GERMANY_COMPANY = "Microsoft Germany"
MICROSOFT_GERMANY_SOURCE = "microsoft_germany"
MICROSOFT_GERMANY_CAREERS_URL = "https://jobs.microsoft.com"
MICROSOFT_GERMANY_SEARCH_URLS = (
    "https://jobs.microsoft.com/search?q=agent&lc=Germany",
    "https://jobs.microsoft.com/search?q=llm&lc=Germany",
    "https://jobs.microsoft.com/search?q=rag&lc=Germany",
)
MICROSOFT_GERMANY_JOB_DOMAINS = ('jobs.microsoft.com',)
KEYWORDS = ("rag", "llm", "agent")


class MicrosoftGermanyCollector:
    name = MICROSOFT_GERMANY_SOURCE
    ...
    def collect(self) -> list[Job]:
        try:
            ...
            raise RuntimeError(
                "MicrosoftGermanyCollector requires Playwright. Install it with "
        ...
        with sync_playwright() as playwright:
            ...
            for search_url in MICROSOFT_GERMANY_SEARCH_URLS:
                try:
                ...
                for listing in self._extract_listing_links(page, search_url):
                    ...
                    jobs.append(
                        Job(
                            ...
                            company=MICROSOFT_GERMANY_COMPANY,
    ...
    def _looks_like_job_url(url: str, title: str) -> bool:
        ...
        if not title or len(title) < 4:
            return False
        if not any(domain in lower_url for domain in MICROSOFT_GERMANY_JOB_DOMAINS):
            return False
