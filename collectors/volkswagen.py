...
VOLKSWAGEN_COMPANY = "Volkswagen"
VOLKSWAGEN_SOURCE = "volkswagen"
VOLKSWAGEN_CAREERS_URL = "https://www.volkswagenag.com/en/group/careers.html"
VOLKSWAGEN_SEARCH_URLS = (
    "https://jobs.volkswagen-group.com/search/?q=agent&locationsearch=Germany",
    "https://jobs.volkswagen-group.com/search/?q=llm&locationsearch=Germany",
    "https://jobs.volkswagen-group.com/search/?q=rag&locationsearch=Germany",
    "https://www.volkswagenag.com/en/group/careers.html",
)
VOLKSWAGEN_JOB_DOMAINS = ('volkswagenag.com', 'jobs.volkswagen-group.com')
KEYWORDS = ("rag", "llm", "agent")


class VolkswagenCollector:
    name = VOLKSWAGEN_SOURCE
    ...
    def collect(self) -> list[Job]:
        try:
            ...
            raise RuntimeError(
                "VolkswagenCollector requires Playwright. Install it with "
        ...
        with sync_playwright() as playwright:
            ...
            for search_url in VOLKSWAGEN_SEARCH_URLS:
                try:
    ...
    def _looks_like_job_url(url: str, title: str) -> bool:
        ...
        if not title or len(title) < 4:
            return False
        if not any(domain in lower_url for domain in VOLKSWAGEN_JOB_DOMAINS):
            return False
