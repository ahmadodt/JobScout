...
GOOGLE_SEARCH_URLS = (
    "https://careers.google.com/jobs/results/?q=agent&location=Germany",
    "https://careers.google.com/jobs/results/?q=llm&location=Germany",
    "https://careers.google.com/jobs/results/?q=rag&location=Germany",
)
GOOGLE_JOB_DOMAINS = ('careers.google.com',)
...
class GoogleCollector:
    ...
    def collect(self) -> list[Job]:
        try:
            ...
            raise RuntimeError(
                "GoogleCollector requires Playwright. Install it with "
        ...
        with sync_playwright() as playwright:
            ...
            for search_url in GOOGLE_SEARCH_URLS:
                try:
    ...
    def _looks_like_job_url(url: str, title: str) -> bool:
        ...
        if not title or len(title) < 4:
            return False
        if not any(domain in lower_url for domain in GOOGLE_JOB_DOMAINS):
            return False
