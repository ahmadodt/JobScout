...
ALLIANZ_COMPANY = "Allianz"
ALLIANZ_SOURCE = "allianz"
ALLIANZ_CAREERS_URL = "https://careers.allianz.com"
ALLIANZ_SEARCH_URLS = (
    "https://careers.allianz.com/search/?q=agent&locationsearch=Germany",
    "https://careers.allianz.com/search/?q=llm&locationsearch=Germany",
    "https://careers.allianz.com/search/?q=rag&locationsearch=Germany",
)
ALLIANZ_JOB_DOMAINS = ('careers.allianz.com',)
KEYWORDS = ("rag", "llm", "agent")


class AllianzCollector:
    name = ALLIANZ_SOURCE
    ...
    def collect(self) -> list[Job]:
        try:
            ...
            raise RuntimeError(
                "AllianzCollector requires Playwright. Install it with "
        ...
        with sync_playwright() as playwright:
            ...
            for search_url in ALLIANZ_SEARCH_URLS:
                try:
    ...
    def _looks_like_job_url(url: str, title: str) -> bool:
        ...
        if not title or len(title) < 4:
            return False
        if not any(domain in lower_url for domain in ALLIANZ_JOB_DOMAINS):
            return False
