...
META_SEARCH_URLS = (
    "https://www.metacareers.com/jobs?q=agent&offices[0]=Germany",
    "https://www.metacareers.com/jobs?q=llm&offices[0]=Germany",
    "https://www.metacareers.com/jobs?q=rag&offices[0]=Germany",
)
META_JOB_DOMAINS = ('metacareers.com',)
...
class MetaCollector:
    ...
    def collect(self) -> list[Job]:
        try:
            ...
            raise RuntimeError(
                "MetaCollector requires Playwright. Install it with "
        ...
        with sync_playwright() as playwright:
            ...
            for search_url in META_SEARCH_URLS:
                try:
    ...
    def _looks_like_job_url(url: str, title: str) -> bool:
        ...
        if not title or len(title) < 4:
            return False
        if not any(domain in lower_url for domain in META_JOB_DOMAINS):
            return False
