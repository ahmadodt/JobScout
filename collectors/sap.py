...
SAP_COMPANY = "SAP"
SAP_SOURCE = "sap"
SAP_CAREERS_URL = "https://jobs.sap.com"
SAP_SEARCH_URLS = (
    "https://jobs.sap.com/search/?q=agent&locationsearch=Germany",
    "https://jobs.sap.com/search/?q=llm&locationsearch=Germany",
    "https://jobs.sap.com/search/?q=rag&locationsearch=Germany",
)
SAP_JOB_DOMAINS = ('jobs.sap.com',)
...
class SAPCollector:
    ...
    def collect(self) -> list[Job]:
        try:
            ...
            raise RuntimeError(
                "SAPCollector requires Playwright. Install it with "
    ...
    def _looks_like_job_url(url: str, title: str) -> bool:
        ...
        if not title or len(title) < 4:
            return False
        if not any(domain in lower_url for domain in SAP_JOB_DOMAINS):
            return False
