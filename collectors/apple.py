...
APPLE_COMPANY = "Apple"
APPLE_SOURCE = "apple"
APPLE_CAREERS_URL = "https://jobs.apple.com"
APPLE_SEARCH_URLS = (
    "https://jobs.apple.com/en-us/search?search=agent&location=germany-DEU",
    "https://jobs.apple.com/en-us/search?search=llm&location=germany-DEU",
    "https://jobs.apple.com/en-us/search?search=rag&location=germany-DEU",
)
APPLE_JOB_DOMAINS = ('jobs.apple.com',)
...
class AppleCollector:
    ...
    def collect(self) -> list[Job]:
        try:
            ...
            raise RuntimeError(
                "AppleCollector requires Playwright. Install it with "
        ...
        with sync_playwright() as playwright:
            ...
            for search_url in APPLE_SEARCH_URLS:
                try:
    ...
    def _looks_like_job_url(url: str, title: str) -> bool:
        ...
        if not title or len(title) < 4:
            return False
        if not any(domain in lower_url for domain in APPLE_JOB_DOMAINS):
            return False
